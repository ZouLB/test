<template>
   <div id="main">
        ...
        <div class="drag">
            ...
            <draggable :list="list1" class="dragArea" :options="{group:{name:'people', pull:'clone', put:false }}" @change="log">
            ...
            <draggable :list="list2" class="dragArea" :options="{group:'people'}" @change="log">
